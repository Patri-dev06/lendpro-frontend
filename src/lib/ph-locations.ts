export const PH_CITIES: Record<string, string[]> = {
  "Metro Manila": [
  ...
  "La Union": [
    ...
    "Rosario", "San Fernando City", "San Gabriel", "San Juan", "Santo Tomas",
    "Santol", "Sibuco", "Sudipen", "Tubao",
  ],
  "Pangasinan": [
    ...
    "Pozzorubio", "Rosales", "San Carlos City", "San Fabian", "San Jacinto",
  ...
  "Bulacan": [
    ...
    "Meycauayan City", "Norzagaray", "Obando", "Pandi", "Paombong",
    "Plaridel", "Pulilan", "San Ildefonso", "San Jose del Monte City",
    "San Miguel", "San Rafael", "Santa Maria",
  ],
  "Nueva Ecija": [
    "Aliaga", "Bongabon", "Cabanatuan City", "Cabiao", "Carranglan",
    "Cuyapo", "Gabaldon", "Gapan City", "General Mamerto Natividad",
    "General Tinio", "Guimba", "Jaen", "Laur", "Licab", "Llanera",
    "Lupao", "Muñoz City", "Nampicuan", "Palayan City", "Pantabangan",
    "Peñaranda", "Quezon", "Rizal", "San Antonio", "San Isidro",
    "San Jose City", "San Leonardo", "Santa Rosa", "Santo Domingo",
  ...
  "Tarlac": [
    ...
    "San Clemente", "San Jose", "San Manuel", "Santa Ignacia", "Tarlac City",
    "Victoria",
  ],
  "Zambales": [
  ...
  "Quezon": [
    ...
    "Pagbilao", "Panukulan", "Patnanungan", "Perez", "Pitogo",
    "Plaridel", "Polillo", "Quezon", "Real", "Sampaloc", "San Andres",
    "San Antonio", "San Francisco", "San Narciso", "Sariaya", "Tagkawayan",
  ...
  "Palawan": [
    ...
    "El Nido", "Kalayaan", "Linapacan", "Magsaysay", "Narra", "Puerto Princesa City",
  ...
  "Albay": [
    ...
    "Pio Duran", "Polangui", "Rapu-Rapu", "Santo Domingo", "Tabaco City",
    "Tiwi",
  ],
  "Camarines Norte": [
  ...
  "Camarines Sur": [
    ...
    "Gainza", "Garchitorena", "Goa", "Iriga City", "Lagonoy", "Libmanan",
    "Lupi", "Magarao", "Milaor", "Minalabac", "Nabua", "Naga City",
  ...
  "Capiz": [
    ...
    "President Roxas", "Roxas City", "Sapi-an", "Sigma", "Tapaz",
  ],
  ...
  "Negros Occidental": [
    ...
    "Candoni", "Cauayan", "Enrique B. Magalona", "Escalante City",
    "Himamaylan City", "Hinigaran", "Hinoba-an", "Ilog", "Isabela",
    "Kabankalan City", "La Carlota City", "La Castellana", "Manapla",
    "Moises Padilla", "Murcia", "Pontevedra", "Pulupandan", "Sagay City",
    "San Carlos City", "San Enrique", "Silay City", "Sipalay City",
  ...
  "Bohol": [
    ...
    "Sikatuna", "Tagbilaran City", "Talibon", "Trinidad", "Tubigon",
    "Ubay", "Valencia",
  ],
  "Cebu": [
  ...
  "Negros Oriental": [
    ...
    "San Jose", "Santa Catalina", "Siaton", "Sibulan", "Tanjay City",
  ...
  "Leyte": [
    ...
    "Baybay City", "Burauen", "Calubian", "Capoocan", "Carigara",
    "Dagami", "Dulag", "Hilongos", "Hindang", "Inopacan", "Isabel",
    "Jaro", "Javier", "Julita", "Kananga", "La Paz", "Leyte",
    "Liloan", "Macarthur", "Mahaplag", "Matag-ob", "Matalom", "Mayorga",
    "Merida", "Ormoc City", "Palo", "Palompon", "Pastrana", "San Isidro",
    "San Miguel", "Santa Fe", "Tabango", "Tabontabon", "Tacloban City",
    "Tanauan", "Tolosa", "Tunga", "Villaba",
  ],
  "Northern Samar": [
    "Allen", "Biri", "Bobon", "Capul", "Catarman", "Catubig", "Gamay",
    "Lapinig", "Las Navas", "Lavezares", "Lope de Vega", "Mapanas",
    "Mondragon", "Palapag", "Pambujan", "Rosario", "San Antonio",
    "San Isidro", "San Jose", "San Roque", "San Vicente", "Silvino Lobos",
    "Victoria",
  ],
  "Samar": [
    "Almagro", "Basey", "Calbayog City", "Calbiga", "Catbalogan City",
    "Daram", "Gandara", "Hinabangan", "Jiabong", "Langkaw",
    "Marabut", "Matuguinao", "Motiong", "Pagsanghan", "Paranas",
    "Pinabacdao", "San Jorge", "San Jose de Buan", "San Sebastian",
    "Santa Margarita", "Santa Rita", "Santo Niño", "Tagapul-an",
  ...
  "Zamboanga del Norte": [
    "Baliguian", "Dapitan City", "Dipolog City", "Godod", "Gutalac",
    "Jose Dalman", "Kalawit", "Katipunan", "La Libertad", "Labason",
    "Leon B. Postigo", "Liloy", "Manukan", "Mutia", "Piñan",
    "Polanco", "President Manuel A. Roxas", "Rizal", "Salug",
    "San Miguel", "Sergio Osmeña Sr.", "Siayan", "Sibuco", "Sibutad",
    "Sindangan", "Siocon", "Sirawai", "Tampilisan",
  ],
  "Zamboanga del Sur": [
    "Aurora", "Bayog", "Dimataling", "Dinas", "Dumalinao", "Dumingag",
    "Guipos", "Josefina", "Kumalarang", "Labangan", "Lapuyan",
    "Mahayag", "Margosatubig", "Midsalip", "Molave", "Pagadian City",
    "Pitogo", "Ramon Magsaysay", "San Miguel", "San Pablo", "Tabina",
    "Tambulig", "Tukuran", "Vincenzo A. Sagun", "Zamboanga City",
  ],
  "Zamboanga Sibugay": [
    "Alicia", "Buug", "Diplahan", "Imelda", "Ipil", "Kabasalan",
    "Mabuhay", "Malangas", "Naga", "Olutanga", "Payao", "Roseller T. Lim",
  ...
  "Misamis Oriental": [
    ...
    "Lugait", "Magsaysay", "Manticao", "Medina", "Naawan", "Opol",
  ...
  "Davao del Norte": [
    ...
    "Panabo City", "San Isidro", "Santo Tomas", "Tagum City",
    "Talaingod",
  ],
  "Davao del Sur": [
  ...
  "Davao Occidental": [
    "Don Marcelino", "Jose Abad Santos", "Malita", "Santa Maria",
    "Sarangani",
  ],
  "Davao Oriental": [
  ...
  "Cotabato": [
    ...
    "Kabacan", "Kidapawan City", "Libungan", "Magpet", "Makilala",
    "Matalam", "Midsayap", "M'lang", "Pigcawayan", "Pikit", "President Roxas",
    "Tulunan",
  ],
  "Sarangani": [
  ...
  "Agusan del Sur": [
    "Bayugan City", "Bunawan", "Esperanza", "La Paz", "Loreto", "Osmeña",
    "Prosperidad", "Rosario", "San Francisco", "San Luis", "Santa Josefa",
    "Santo Tomas", "Sibagat", "Talacogon", "Trento", "Veruela",
  ],
  "Dinagat Islands": [
  ...
  "Basilan": [
    ...
    "Isabela City", "Lamitan City", "Lantawan", "Maluso", "Sumisip",
  ...
  "Lanao del Sur": [
    ...
    "Masiu", "Mulondo", "Pagayawan", "Piagapo", "Picong", "Poona Bayabao",
    "Pualas", "Saguiaran", "Sultan Dumalondong", "Tagoloan II", "Tamparan",
  ...
  "Sulu": [
    ...
    "Luuk", "Maimbung", "Old Panamao", "Omar", "Pangutaran", "Parang",
    "Pata", "Patikul", "Siasi", "Talipao", "Tapul", "Tongkil",
  ],
  "Tawi-Tawi": [
...
export const PH_PROVINCES = Object.keys(PH_CITIES).sort((a, b) => {
  // Keep Metro Manila at top
  if (a === "Metro Manila") return -1;
  if (b === "Metro Manila") return 1;
