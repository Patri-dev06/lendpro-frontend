...
export const Route = createFileRoute("/_app/loans")({
  validateSearch: (search: Record<string, unknown>) => ({
    clientId: typeof search.clientId === "number" ? search.clientId : undefined,
  }),
...
function LoansPage() {
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <LoanCreateSection token={token} onLoanCreated={handleLoanCreated} initialClientId={clientId} />
